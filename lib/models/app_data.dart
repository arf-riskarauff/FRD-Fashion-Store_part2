...
class AppData {
  ...
  static List<Product> featuredProducts = [
    ...
    Product(
      ...
      reviews: 95,
      description:
          "Trendy Hand Bag with a stylish design and premium finish. Spacious, lightweight, and perfect for daily use or special occasions. A perfect accessory to complete your fashionable look.",
    ),
    Product(
